...
I try to use as much open-source software as possible and my goal is to have no subscriptions for
proprietary services. For now this is the case :)

Most of my application setups are in here first of all for my dementia and second to copy or adjust
to ones needs.

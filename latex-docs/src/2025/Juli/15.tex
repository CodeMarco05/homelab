...
\subsection{CPU limiting}
Die CPU can gelimeted werden, sodass man einer vm viele kerne geben kann, sie jedoch nicht alle gleichzeitig voll auslasten kann. Hierzu gibt es die Optionen in bei der \it{Hardware} für die einzelnen VMs. 

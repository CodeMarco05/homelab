...
curl -sfL https://get.k3s.io | INSTALL_K3S_EXEC="\
  --node-ip=<server_vpn_ip> \
  --advertise-address=<server_vpn_ip> \
  --node-external-ip=<server_public_ip> \
  --flannel-iface=<vpn_interface_name> \
  --tls-san=<server_vpn_ip> \
...
\begin{verbatim}
export K3S_URL="https://<server_vpn_ip>:6443"
export K3S_TOKEN="<server_join_token>"
